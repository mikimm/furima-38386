  ...
  describe 'ユーザー新規登録' do
    ...
    context '新規登録できない場合' do
      ...
      it 'lastnameが半角では登録できない' do
        @user.lastname = 'aaaa'
        @user.valid?
        expect(@user.errors.full_messages).to include('Lastname 無効です。全角文字を入力します。')
      end
      ...
      it 'firstnameが半角では登録できない' do
        @user.firstname = 'miki'
        @user.valid?
        expect(@user.errors.full_messages).to include('Firstname 無効です。全角文字を入力します。')
      end
      ...
      it 'lastname_kanaにカタカナ以外の文字（平仮名・漢字・英数字・記号）が含まれていると登録できない' do
        ...
        @user.valid?
        expect(@user.errors.full_messages).to include('Lastname kana 無効です。全角文字カタカナを入力します。')
      end
      ...
      it 'firstname_kanaにカタカナ以外の文字（平仮名・漢字・英数字・記号）が含まれていると登録できない' do
        ...
        @user.valid?
        expect(@user.errors.full_messages).to include('Firstname kana 無効です。全角文字カタカナを入力します。')
      end
